...
| --- | --- | --- | ---: |
| `astro-discussion-bridge-0.2.0-alpha.19.tgz` | Alpha.19 Astro adapter with canonical Interactive output and historical `fullInteractive` input compatibility | `1e4d7eaa4f02790ff262f9b279d428df2bf9fc5d286ade287912b5e5df277140` | 43930 |
...
`b52a0999f567269805ba5ffa27faf3f40ed03688` (tree
`9878569eec34eff17a259272abfd3c463e7d84b7`). A fresh `npm pack` from that
