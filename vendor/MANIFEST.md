...
| --- | --- | --- | ---: |
| `astro-discussion-bridge-0.2.0-alpha.20.tgz` | Alpha.20 Astro adapter with canonical Interactive output and historical `fullInteractive` input compatibility | `b63b62a40a1283d9b333f1a35c7b44da3976f029c8b2b9548ad2e0388d5f82f9` | 43930 |
...
`f0610945beedc4cca54c11440d4794ce92b17ff5` (tree
`06b7adf018b27809e1c6cef6dcda9ee69131ced1`). A fresh `npm pack` from that
